...
other=${CORE_OPTIONS:-"-XX:NativeMemoryTracking=summary -XX:+UnlockDiagnosticVMOptions -XX:+AlwaysPreTouch -XX:+PreserveFramePointer -XX:+UnlockCommercialFeatures -XX:+FlightRecorder -XX:+DebugNonSafepoints"}
